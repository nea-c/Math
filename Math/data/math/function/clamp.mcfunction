...
execute unless data storage math:internal {w_validation_min:0.0f} run return run function math:internal/invalid_number
data modify storage math:internal w_validation_max set compute default math:internal/comparison/finite/max
execute unless data storage math:internal {w_validation_max:0.0f} run return run function math:internal/invalid_number
...
data modify storage math:internal w_comparison.predicate.range_min_greater_than_max.maximum set compute default math:internal/comparison/predicate/range/min_greater_than_max/maximum

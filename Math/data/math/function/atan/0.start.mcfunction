...
execute if predicate math:atan_invert run data modify storage math: internal.x set compute default float {type:"div",left:1,right:{type:"storage",storage:"math:",path:"internal.abs"}}
data modify storage math: internal.result set compute default float math:atan
execute if predicate math:atan_invert run data modify storage math: internal.result set compute default float {type:"sub",left:1.5707963267948966192313216916398,right:{type:"storage",storage:"math:",path:"internal.result"}}

...
data modify storage math:internal w_comparison.predicate.bounce_duration_positive set compute default float math:internal/comparison/predicate/bounce/duration_positive/value
execute unless predicate math:internal/bounce/duration_positive run return run function math:.common/_error/invalid_duration
data modify storage math:internal w_comparison.predicate.bounce_time_at_or_below_start set compute default float math:internal/comparison/predicate/bounce/time_at_or_below_start/value
execute if predicate math:internal/bounce/time_at_or_below_start run data modify storage math: ans set compute default float math:.common/input/a
execute if predicate math:internal/bounce/time_at_or_below_start run return 1
data modify storage math:internal w_comparison.predicate.bounce_time_at_or_after_end set compute default float math:internal/comparison/predicate/bounce/time_at_or_after_end/value
execute if predicate math:internal/bounce/time_at_or_after_end run data modify storage math: ans set compute default float math:.common/input/b
...
data modify storage math:internal w_comparison.predicate.bounce_duration_subnormal set compute default float math:internal/comparison/predicate/bounce/duration_subnormal/value
execute if predicate math:internal/bounce/duration_subnormal run data modify storage math:internal w_bounce_scaled_t set compute default float math:bounce/scaled_t
execute if predicate math:internal/bounce/duration_subnormal run data modify storage math:internal x set compute default float math:bounce/scaled_max

...
data modify storage math:internal w_comparison.predicate.bounce_duration_positive.minimum set compute default math:internal/comparison/predicate/bounce/duration_positive/minimum
...
data modify storage math:internal w_comparison.predicate.bounce_time_at_or_below_start.maximum set compute default math:internal/comparison/predicate/bounce/time_at_or_below_start/maximum
execute if predicate math:internal/bounce/time_at_or_below_start run data modify storage math: ans set compute default math:common/input/a
...
data modify storage math:internal w_comparison.bounce_0 set compute default math:bounce/compare_0
data modify storage math:internal w_comparison.bounce_1 set compute default math:bounce/compare_1
data modify storage math:internal w_comparison.bounce_2 set compute default math:bounce/compare_2

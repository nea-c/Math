...
data modify storage math:internal w_comparison.predicate.tan_undefined_radians set compute default float math:internal/comparison/predicate/tan/undefined_radians/value

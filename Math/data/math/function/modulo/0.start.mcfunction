...
data modify storage math:internal w_comparison.predicate.rounding_remainder_zero.value set compute default math:internal/comparison/predicate/rounding/remainder/zero/value
...
data modify storage math:internal w_comparison.predicate.rounding_public_a_negative.maximum set compute default math:internal/comparison/predicate/rounding/public/a_negative/maximum
data modify storage math:internal w_comparison.predicate.rounding_public_b_negative.maximum set compute default math:internal/comparison/predicate/rounding/public/b_negative/maximum
execute if predicate math:internal/rounding/public/b_negative run return run function math:modulo/1.negative_b

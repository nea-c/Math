...
data modify storage math:comparison tan_domain set compute default math:tan/guard/radians/compare_domain
data modify storage math:comparison predicate.tan_undefined_radians.maximum set compute default math:internal/comparison/predicate/tan/undefined_radians/maximum

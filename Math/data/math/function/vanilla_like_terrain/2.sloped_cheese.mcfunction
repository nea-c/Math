...
data modify storage math: internal.noise.terrain.scale_x set value 1.0f
data modify storage math: internal.noise.terrain.scale_y set value 0.5f
data modify storage math: internal.noise.terrain.scale_z set value 1.0f

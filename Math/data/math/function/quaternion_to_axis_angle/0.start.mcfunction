...
data modify storage math:internal w_quaternion_component_0 set compute default math:quaternion_to_axis_angle/input/rotation_0
data modify storage math:internal w_validation_rotation_0 set compute default math:internal/comparison/finite/rotation_0
...
data modify storage math:internal w_quaternion_component_1 set compute default math:quaternion_to_axis_angle/input/rotation_1
data modify storage math:internal w_validation_rotation_1 set compute default math:internal/comparison/finite/rotation_1
...
data modify storage math:internal w_quaternion_component_2 set compute default math:quaternion_to_axis_angle/input/rotation_2
data modify storage math:internal w_validation_rotation_2 set compute default math:internal/comparison/finite/rotation_2
...
data modify storage math:internal w_quaternion_component_3 set compute default math:quaternion_to_axis_angle/input/rotation_3
data modify storage math:internal w_validation_rotation_3 set compute default math:internal/comparison/finite/rotation_3
...
data modify storage math:internal w_quaternion_maximum set compute default math:quaternion_to_axis_angle/normalize/maximum
data modify storage math:internal w_comparison.predicate.quaternion_to_axis_angle_maximum_zero.value set compute default math:internal/comparison/predicate/quaternion_to_axis_angle/maximum_zero/value
execute if predicate math:internal/quaternion_to_axis_angle/maximum_zero run return run function math:.common/_error/invalid_quaternion

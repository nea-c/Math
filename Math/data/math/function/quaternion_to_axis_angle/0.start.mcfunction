...
data modify storage math:internal w_validation_rotation_0 set compute default float math:internal/comparison/finite/rotation_0
...
data modify storage math:internal w_validation_rotation_1 set compute default float math:internal/comparison/finite/rotation_1
...
data modify storage math:internal w_validation_rotation_2 set compute default float math:internal/comparison/finite/rotation_2
...
data modify storage math:internal w_validation_rotation_3 set compute default float math:internal/comparison/finite/rotation_3
...
data modify storage math:internal w_comparison.predicate.quaternion_to_axis_angle_maximum_zero set compute default float math:internal/comparison/predicate/quaternion_to_axis_angle/maximum_zero/value

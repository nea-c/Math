...
data modify storage math:comparison sqrt.scale set from storage math:internal w
data modify storage math:comparison sqrt.mantissa set from storage math:internal z
...
data modify storage math:internal y set from storage math:comparison sqrt.mantissa
...
data modify storage math:internal z set from storage math:internal x
data modify storage math:internal w set from storage math:comparison sqrt.scale
data remove storage math:comparison sqrt
data modify storage math: ans set compute default math:square_root/00
data modify storage math:comparison predicate.square_root_result_finite.minimum set compute default math:internal/comparison/predicate/square_root/result_finite/minimum
data modify storage math:comparison predicate.square_root_result_finite.maximum set compute default math:internal/comparison/predicate/square_root/result_finite/maximum

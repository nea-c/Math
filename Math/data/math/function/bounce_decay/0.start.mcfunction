...
data modify storage math:internal w_validation_bounces set compute default float math:internal/comparison/finite/bounces
...
data modify storage math:internal w_validation_decay set compute default float math:internal/comparison/finite/decay
...
data modify storage math:internal w_comparison.predicate.bounce_decay_duration_positive set compute default float math:internal/comparison/predicate/bounce_decay/duration_positive/value
...
data modify storage math:internal w_comparison.predicate.bounce_decay_bounces_positive set compute default float math:internal/comparison/predicate/bounce_decay/bounces_positive/value

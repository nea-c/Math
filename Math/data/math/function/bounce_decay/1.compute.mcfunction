...
data modify storage math: internal.wave set compute default float math:bounce_decay/wave
data modify storage math: internal.factor set compute default float math:bounce_decay/exponent
data modify storage math: internal.eased set compute default float math:bounce_decay/eased

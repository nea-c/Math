...
execute if predicate math:.validation/bounce_decay/time_at_or_below_start run return run data modify storage math: ans set compute default float math:.common/input/a
...
execute if predicate math:.validation/bounce_decay/time_at_or_after_end run return run data modify storage math: ans set compute default float math:.common/input/b

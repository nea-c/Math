...
data modify storage math:comparison validation_t set compute default math:internal/comparison/finite/t
execute unless data storage math:comparison {validation_t:0.0f} run return run function math:internal/invalid_number

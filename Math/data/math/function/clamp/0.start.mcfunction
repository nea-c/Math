...
data modify storage math:internal w_validation_min set compute default float math:internal/comparison/finite/min
...
data modify storage math:internal w_comparison.predicate.range_min_greater_than_max set compute default float math:internal/comparison/predicate/range/min_greater_than_max/value

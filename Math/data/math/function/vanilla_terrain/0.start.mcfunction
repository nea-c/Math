...
function math:vanilla_terrain/1.climate
function math:vanilla_terrain/2.sloped_cheese
function math:vanilla_terrain/3.caves
function math:vanilla_terrain/4.final
data remove storage math: internal.noise

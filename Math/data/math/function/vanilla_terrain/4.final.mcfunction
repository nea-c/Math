...
data modify storage math: internal.noise.terrain.noodle_carved set compute default float math:.common/noise/terrain/noodle_carved
data modify storage math: internal.noise.terrain.noodle_y_gate set compute default float math:.common/noise/terrain/noodle_y_gate

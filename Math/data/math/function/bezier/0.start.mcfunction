...
data modify storage math:internal w_validation_curve_1 set compute default float math:internal/comparison/finite/curve_1
...
data modify storage math:internal w_validation_curve_2 set compute default float math:internal/comparison/finite/curve_2
...
data modify storage math:internal w_validation_curve_3 set compute default float math:internal/comparison/finite/curve_3
...
data modify storage math:internal w_comparison.predicate.bezier_duration_positive set compute default float math:internal/comparison/predicate/bezier/duration_positive/value
...
data modify storage math:internal w_comparison.predicate.bezier_x1_in_range set compute default float math:internal/comparison/predicate/bezier/x1_in_range/value
execute unless predicate math:internal/bezier/x1_in_range run return run function math:.common/_error/invalid_curve
data modify storage math:internal w_comparison.predicate.bezier_x2_in_range set compute default float math:internal/comparison/predicate/bezier/x2_in_range/value
execute unless predicate math:internal/bezier/x2_in_range run return run function math:.common/_error/invalid_curve
data modify storage math:internal w_comparison.predicate.bezier_time_at_or_below_start set compute default float math:internal/comparison/predicate/bezier/time_at_or_below_start/value
...
data modify storage math:internal w_comparison.predicate.bezier_time_at_or_after_end set compute default float math:internal/comparison/predicate/bezier/time_at_or_after_end/value

...
execute if predicate math:.validation/rounding/remainder/zero run data modify storage math: ans set value 0.0f
execute if predicate math:.validation/rounding/remainder/zero run return 1
...
execute if predicate math:.validation/rounding/public/b_negative run return run function math:mod/1.negative_b

...
data modify storage math:internal w_comparison.predicate.exp_input_in_range set compute default float math:internal/comparison/predicate/exp/input_in_range/value
...
data modify storage math:internal w_comparison.predicate.exp_underflows_to_zero set compute default float math:internal/comparison/predicate/exp/underflows_to_zero/value

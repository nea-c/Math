...
execute if data storage math: {internal:{x:-103.97207641601562f}} run data modify storage math: ans set compute default float {"type":"minecraft:constant","value":1.401298464324817e-45}

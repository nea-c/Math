...
return run data modify storage math: internal.x set compute default float {"type":"minecraft:mul","inputs":["math:exp/polynomial/00","math:exp/factor/00","math:exp/scale/00"]}

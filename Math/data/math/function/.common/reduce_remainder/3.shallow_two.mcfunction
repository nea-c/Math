...
execute if predicate math:.validation/rounding/remainder/y_too_large_to_double run return run function math:.common/reduce_remainder/6.subtract_finish_two
...
execute if predicate math:.validation/rounding/remainder/w_greater_than_x run return run function math:.common/reduce_remainder/6.subtract_finish_two
return 1

...
execute if data storage math: {internal:{w_inverse_trigonometry_input:-1.0f}} run return run data modify storage math: internal.x set compute default float {"type":"constant","value":3.1415926535897932384626433832795}

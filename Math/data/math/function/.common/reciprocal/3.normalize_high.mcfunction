...
data modify storage math: internal.x set compute default float {"type":"mul","inputs":[0.5,{"type":"storage","storage":"math:","path":"internal.x"}]}
data modify storage math: internal.y set compute default float {"type":"mul","inputs":[0.5,{"type":"storage","storage":"math:","path":"internal.y"}]}

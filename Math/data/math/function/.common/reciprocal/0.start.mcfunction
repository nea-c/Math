data modify storage math:internal w set compute default float math:internal/reciprocal/compare/below_one
...
data modify storage math:internal w set compute default float math:internal/reciprocal/compare/at_least_two

data modify storage math: internal.w_reciprocal_mantissa set compute default float math:.common/reciprocal/mantissa
data modify storage math: internal.w_reciprocal_estimate set compute default float math:.common/reciprocal/initial_estimate

...
data modify storage math:internal x set compute default float math:internal/reciprocal/scale_b
data modify storage math:internal x set compute default float math:internal/reciprocal/apply_sign
return 1

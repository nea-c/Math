...
data modify storage math: internal.x set compute default float {"type":"minecraft:mul","inputs":[2,{"type":"minecraft:storage","storage":"math:","path":"internal.x"}]}
data modify storage math: internal.y set compute default float {"type":"minecraft:mul","inputs":[2,{"type":"minecraft:storage","storage":"math:","path":"internal.y"}]}

...
execute if predicate math:.validation/asin_positive/before_target run data modify storage math:internal w_asin_low set from storage math:internal w_asin_midpoint
execute unless predicate math:.validation/asin_positive/before_target run data modify storage math:internal w_asin_high set from storage math:internal w_asin_midpoint
return 1

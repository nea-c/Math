...
execute if predicate math:.validation/atan/use_pi_four run data modify storage math: internal.x set compute default float {"type":"add","inputs":[0.7853981852531433,{"type":"storage","storage":"math:","path":"internal.x"}]}

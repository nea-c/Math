...
execute if predicate math:.validation/atan/use_pi_four run data modify storage math: internal.x set compute default float math:.common/atan/after_pi_four

...
execute if data storage math: {internal:{w_inverse_trigonometry_input:-1.0f}} run return run data modify storage math: internal.x set compute default float math:.common/rounding/negate
...
execute if data storage math: {internal:{w_inverse_trigonometry_input:0.0f}} run return run data modify storage math: internal.x set compute default float math:.common/input/x
...
execute if predicate math:.validation/inverse_trigonometry/use_complement run data modify storage math: internal.w_inverse_trigonometry_square_target set compute default float math:.common/inverse_trigonometry/complement
execute if predicate math:.validation/inverse_trigonometry/use_complement run function math:.common/inverse_trigonometry/0.start
execute if predicate math:.validation/inverse_trigonometry/use_complement run function math:.common/asin_positive/0.start
execute if predicate math:.validation/inverse_trigonometry/use_complement run data modify storage math: internal.w_inverse_trigonometry_half_pi set compute default float math:.common/inverse_trigonometry/half_pi
execute if predicate math:.validation/inverse_trigonometry/use_complement run data modify storage math: internal.x set compute default float math:.common/inverse_trigonometry/acos

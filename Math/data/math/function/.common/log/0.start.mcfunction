...
data modify storage math: internal.w_log_mantissa set compute default float math:.common/reciprocal/log_mantissa
...
data modify storage math: internal.w_log_reciprocal set compute default float math:.common/reciprocal/log_newton
data modify storage math: internal.w_log_reciprocal set compute default float math:.common/reciprocal/log_newton
data modify storage math: internal.x set compute default float math:.common/reciprocal/log_denominator

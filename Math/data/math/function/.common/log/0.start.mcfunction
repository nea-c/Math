...
data modify storage math: internal.z set compute default float {"type":"add","inputs":[{"type":"storage","storage":"math:","path":"internal.z"},-1]}
data modify storage math: internal.x set compute default float {"type":"add","inputs":[{"type":"storage","storage":"math:","path":"internal.z"},2]}
data modify storage math: internal.w_log_mantissa set compute default float {"type":"mul","inputs":[0.25,{"type":"storage","storage":"math:","path":"internal.x"}]}
...
data modify storage math: internal.w_log_reciprocal set compute default float math:.common/reciprocal/log_newton
data modify storage math: internal.w_log_reciprocal set compute default float math:.common/reciprocal/log_newton
data modify storage math: internal.x set compute default float {"type":"mul","inputs":[0.25,{"type":"storage","storage":"math:","path":"internal.w_log_reciprocal"}]}

data modify storage math: internal.noise.surface.scale set value 0.00125f
...
data modify storage math: internal.noise.surface.scale set value 0.0025f
...
data modify storage math: internal.noise.surface.scale set value 0.004f
...
data modify storage math: internal.noise.surface.mountain set compute default float math:.common/noise/surface/mountain

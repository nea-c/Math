...
data modify storage math:internal w_comparison.predicate.power_exponent_negative set compute default float math:internal/comparison/predicate/power/exponent_negative/value

...
execute if data storage math: {internal:{x:0.0f}} run function math:pow/2.zero
...
execute if predicate math:.validation/range/negative run function math:pow/3.negative

...
data modify storage math:internal w_validation_oscillations set compute default float math:internal/comparison/finite/oscillations
...
data modify storage math:internal w_validation_damping set compute default float math:internal/comparison/finite/damping
...
data modify storage math:internal w_comparison.predicate.elastic_decay_duration_positive set compute default float math:internal/comparison/predicate/elastic_decay/duration_positive/value
...
data modify storage math:internal w_comparison.predicate.elastic_decay_oscillations_positive set compute default float math:internal/comparison/predicate/elastic_decay/oscillations_positive/value
...
data modify storage math:internal w_comparison.predicate.elastic_decay_damping_positive set compute default float math:internal/comparison/predicate/elastic_decay/damping_positive/value
...
data modify storage math:internal w_comparison.predicate.elastic_decay_time_at_or_below_start set compute default float math:internal/comparison/predicate/elastic_decay/time_at_or_below_start/value
...
data modify storage math:internal w_comparison.predicate.elastic_decay_time_at_or_after_end set compute default float math:internal/comparison/predicate/elastic_decay/time_at_or_after_end/value

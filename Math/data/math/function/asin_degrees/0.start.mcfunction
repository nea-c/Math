...
execute if predicate math:internal/inverse_trigonometry/input_in_range run data modify storage math:internal x set compute default float math:.common/deg

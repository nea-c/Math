...
execute if predicate math:internal/inverse_trigonometry/input_in_range run data modify storage math:internal x set from storage math: a
execute if predicate math:internal/inverse_trigonometry/input_in_range run function math:.common/asin/0.start
execute if predicate math:internal/inverse_trigonometry/input_in_range run data modify storage math:internal x set compute default math:common/conversion/deg

...
data modify storage math:internal w_validation_amplitude set compute default math:internal/comparison/finite/amplitude
...
data modify storage math:internal w_elastic_amplitude set compute default math:elastic/input/amplitude
data modify storage math:internal w_validation_period set compute default math:internal/comparison/finite/period
...
data modify storage math:internal w_comparison.predicate.elastic_duration_positive.minimum set compute default math:internal/comparison/predicate/elastic/duration_positive/minimum
...
data modify storage math:internal w_comparison.predicate.elastic_amplitude_valid.minimum set compute default math:internal/comparison/predicate/elastic/amplitude_valid/minimum
...
data modify storage math:internal w_comparison.predicate.elastic_period_positive.minimum set compute default math:internal/comparison/predicate/elastic/period_positive/minimum
...
data modify storage math:internal w_comparison.predicate.elastic_time_at_or_below_start.maximum set compute default math:internal/comparison/predicate/elastic/time_at_or_below_start/maximum
...
data modify storage math:internal w_comparison.predicate.elastic_time_at_or_after_end.minimum set compute default math:internal/comparison/predicate/elastic/time_at_or_after_end/minimum
...
execute if data storage math:internal {w_elastic_amplitude:1.0f} run data modify storage math:internal x set compute default math:common/asin_positive/half_pi

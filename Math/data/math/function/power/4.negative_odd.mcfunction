...
execute unless predicate math:internal/exp/input_finite run return run function math:power/6.nonfinite_negative
...
execute if predicate math:internal/power/needs_overflow_classification run return run function math:power/8.boundary_negative

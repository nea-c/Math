...
execute if data storage math:internal {x:0.0f} run return run function math:power/1.zero
...
execute if predicate math:internal/range/negative run return run function math:power/2.negative

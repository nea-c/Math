...
data modify storage math:comparison predicate.power_exponent_negative.maximum set compute default math:internal/comparison/predicate/power/exponent_negative/maximum

...
data modify storage math:comparison predicate.exp_input_finite.minimum set compute default math:internal/comparison/predicate/exp/input_finite/minimum
data modify storage math:comparison predicate.exp_input_finite.maximum set compute default math:internal/comparison/predicate/exp/input_finite/maximum
execute unless predicate math:internal/exp/input_finite run return run function math:internal/power_nonfinite_positive
...
data modify storage math:comparison predicate.power_needs_overflow_classification.minimum set compute default math:internal/comparison/predicate/power/needs_overflow_classification/minimum
data modify storage math:comparison predicate.power_needs_overflow_classification.maximum set compute default math:internal/comparison/predicate/power/needs_overflow_classification/maximum
execute if predicate math:internal/power/needs_overflow_classification run return run function math:internal/power_boundary_positive

...
data modify storage math:comparison predicate.rounding_safe_command_result.maximum set compute default math:internal/comparison/predicate/rounding/safe_command_result/maximum
